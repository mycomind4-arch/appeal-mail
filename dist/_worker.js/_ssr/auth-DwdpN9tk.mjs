...
import { D as CircleCheck, f as Scale, j as ArrowRight } from "../_libs/lucide-react.mjs";
import { i as SiteHeader, r as SiteFooter } from "./router-DzhFuQZY.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-DwdpN9tk.js
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
									...
									style: { fontFamily: "var(--font-serif)" },
									children: "Your appeals, organized and sent."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-4 text-sm leading-7 text-white/60",
									children: "Create an account to save drafts, track mailings, and keep a permanent record of your appeal filings."
								}),
							...
							children: submitted ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "mt-5 text-xl font-bold text-indigo-700",
										style: { fontFamily: "var(--font-serif)" },
								...
								className: "flex gap-1 rounded-xl bg-indigo-50 p-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => setTab("signup"),
									className: `flex-1 rounded-lg px-4 py-2 text-sm font-semibold transition ${tab === "signup" ? "bg-white text-indigo-700 shadow-sm" : "text-slate-400"}`,
									children: "Get notified"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => setTab("signin"),
									className: `flex-1 rounded-lg px-4 py-2 text-sm font-semibold transition ${tab === "signin" ? "bg-white text-indigo-700 shadow-sm" : "text-slate-400"}`,
									children: "Sign in"
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-6",
