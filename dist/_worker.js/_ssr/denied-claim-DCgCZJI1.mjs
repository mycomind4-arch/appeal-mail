...
//#region node_modules/.nitro/vite/services/ssr/assets/denied-claim-DCgCZJI1.js
...
function DeniedClaim() {
	...
	const [claimNumber, setClaimNumber] = (0, import_react.useState)("");
	const [denialDate, setDenialDate] = (0, import_react.useState)("");
	const [appealDeadline, setAppealDeadline] = (0, import_react.useState)("");
	const [policyNumber, setPolicyNumber] = (0, import_react.useState)("");
	const [claimType, setClaimType] = (0, import_react.useState)("");
							...
							children: [
								step === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
										...
										children: "Appeal a denied claim"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-4 leading-7 text-slate-400",
										children: "We'll help you organize the denial, state your grounds, prepare an editable appeal letter, and move toward mailing. Nothing is sent until you review and approve it."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											" Appeal deadlines can be as short as 30–60 days. Note your deadline immediately and plan to mail well before it expires."
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-6 grid gap-3 sm:grid-cols-2",
										children: [
											"Upload or identify the denial",
								...
								step === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "Upload the denial letter or identify the key details here."
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												className: "input-label",
												children: "Policy / reference number"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												className: "input-field",
												value: policyNumber,
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												...
												placeholder: "Auto, health, disability, etc."
											})] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												className: "input-label",
												children: "Denial date"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												type: "date",
												className: "input-field",
												value: denialDate,
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
													className: "input-label",
													children: "Stated reason for denial"
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
													className: "input-field",
													value: denialReason,
													onChange: (e) => setDenialReason(e.target.value),
													placeholder: "e.g., Not medically necessary, not covered, pre-existing condition"
												})]
											})
										]
									})
								...
								step === 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Tip:" }), " Include dates, reference numbers, and evidence. Explain why the denial should be reversed based on the facts and your policy or coverage."]
									})
								] }),
								step === 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
										...
										placeholder: "Example: I want the claim denial reversed and the claim approved based on the evidence enclosed."
									})
								] }),
								...
								step === 6 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Attach evidence, medical records, receipts, or other supporting documents."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								step === 7 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Enter the appeals address from the denial letter."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mt-6 grid gap-4 sm:grid-cols-2",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
													...
													placeholder: "Appeals Department"
												})]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "sm:col-span-2",
								...
								step === 8 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "For appeals, certified mail with return receipt is strongly recommended for proof of timely filing."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-6 grid gap-3 sm:grid-cols-2",
...
//#endregion
export { DeniedClaim as component };
