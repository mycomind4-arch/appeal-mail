...
//#region node_modules/.nitro/vite/services/ssr/assets/faq-DINdZGkP.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var categories = [
	{
		name: "Using Appeal Mail",
		questions: [
			{
				q: "Is this legal advice?",
				a: "No. Appeal Mail is a correspondence tool, not a law firm. We help you prepare and send appeal documents — we do not provide legal advice, and the AI assistant never invents facts or legal conclusions."
			},
			{
	...
	},
	{
		...
		questions: [
			...
			{
				q: "What's proof of timely filing?",
	...
	},
	{
		name: "Legal & Scope",
		questions: [{
			q: "Is Appeal Mail a law firm?",
			a: "No. Appeal Mail is a document preparation and mailing service. We do not provide legal advice or representation."
		}, {
			q: "Can this replace an attorney?",
			a: "No. If your appeal involves complex legal questions, consult a qualified attorney."
		}]
	}
];
function FAQPage() {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Everything you need to know about how Appeal Mail works."
							})
						]
					})
				})
