      ...
      <section className="py-20 md:py-32">
        <div className="container max-w-lg text-center">
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-indigo-50">
            <Scale size={36} className="text-indigo-300" />
          </div>
          <h1 className="mt-8 text-6xl font-bold text-indigo-700" style={{ fontFamily: "var(--font-serif)" }}>404</h1>
          <h2 className="mt-2 text-xl font-semibold text-indigo-500">This ruling is being appealed elsewhere</h2>
