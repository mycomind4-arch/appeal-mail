...
import { buildPacket, computePacketBytesHash, type PacketPageOp, type PacketPart } from "@/platform/packet-builder";
...
export const Route = createFileRoute("/api/packets/build")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        try {
