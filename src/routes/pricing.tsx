...
const tiers = [
  { type: "First-Class", price: "$3.99", desc: "Standard delivery for non-urgent requests", features: ["3–5 business days", "USPS tracking included", "Professional printing & envelope", "Mailing record retained"], icon: Mail },
  ...
  { type: "Certified + Return Receipt", price: "$12.99", desc: "Signed return receipt card mailed back to you", features: ["3–5 business days", "All Certified features", "Signed return receipt card", "Recommended for appeals"], icon: ShieldCheck, featured: true },
