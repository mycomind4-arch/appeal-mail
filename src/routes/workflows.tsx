...
import { appealWorkflowCount, workflows } from "@/domain/workflows";

export const Route = createFileRoute("/workflows")({
  head: () => ({
    meta: [
      { title: "Appeal Workflows — Appeal Mail" },
      { name: "description", content: "Browse 32 problem-specific Appeal Mail workflows. Upload the decision or denial, let Gemini analyze it, build the response, review it, and prepare it for mailing." },
