...
export const Route = createFileRoute("/workflows/financial-aid-reinstatement")({
  head: () => ({ meta: [{ title: `${getWorkflow("financial-aid-reinstatement").title} — Appeal Mail` }, { name: "description", content: getWorkflow("financial-aid-reinstatement").description }] }),
