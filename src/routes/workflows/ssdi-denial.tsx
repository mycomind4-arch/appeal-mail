    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Upload your SSDI denial notice, understand the findings, build a reconsideration or hearing request, and send it by certified mail to the SSA.",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "SSDI Denial", item: "/workflows/ssdi-denial" },
          ],
        }),
      },
